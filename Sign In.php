    ...
    <body>
        ...
        <div class="container">
			...
			<header>
				 ...
				 <h1><p> <a href="Sign In.php"><img src="images/logo1.png" alt="Post Image" height="80" width="130"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>INstore <strong>Login Form</strong> <span>Please Login Or Sign Up </span></p> </h1>
