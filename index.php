		...
		<div id="slider">
			...
			<div class="shell">
				<ul class="slider-items">
					...
					<li>
						<img src="images/sl9.png" alt="Slide Image" />
						<div class="slide-entry">
							<h4><span></span><span class="small"></span> &nbsp; Drinks </h4>
							...
							<li>
						<img src="images/sl4.png" alt="Slide Image" />
						<div class="slide-entry">
					...
					<li>
						<img src="images/sl7.png" alt="Slide Image" />
						<div class="slide-entry">
							<h2><span>Cleaning</span>Material</h2>
					...
					<li>
						...
						<div class="slide-entry">
							...
							<h4 class="short"><span>INStore</span> Products</h4>
      ...
      <!-- Begin Products Slider -->
		...
		<div id="footer">
			<div class="boxes">
				...
				<div class="shell">
					<div class="box post-box">
						<h2>About INStore</h2>
						<div class="box-entry">
							<img src="images/logo1.png" alt="INStore" width="160" height="80"/>
			...
			<div class="copy">
				<!-- Begin Shell -->
				<div class="shell">
						<p>&copy; INstore.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To INstore Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
