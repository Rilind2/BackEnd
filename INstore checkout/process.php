...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<img src="../images/logo1.png" alt="Post Image" height="110" width="130"/>
				<div id="top-nav">
					<ul>
...
?>
                            ...
                            <p>
                                ...
                                <input id="email" name="email" placeholder="costumer@gmail.com" type="email" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
...
?>
                           ...
                           <p>
                                ...
                                <input id="address" name="address" placeholder="e.g. Podujeva " type="text" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
		  ...
		  <option value="ZW" countrynum="263">Zimbabwe</option>
                             ...
                             <p>
                                ...
                                <input id="city" name="city" placeholder="e.g. Podujeva" type="text" AUTOCOMPLETE=OFF />
                            </p>														 

							<p> 
								 <label for="Address"> Phone:</label>
                                <input id="phone" name="phone" placeholder="e.g. +383-44-111222" type="tel" AUTOCOMPLETE=OFF />
                            </p>
...
?>
							...
							<p>
                                ...
                                <input id="delivery" name="delivery" placeholder="e.g. Podujeva" type=" text" AUTOCOMPLETE=OFF />
                            </p>
...
?>
							...
							<p>
								Remember. If You Proceed it Now You Can Find Your Sales Voucher Or Payment Voucher In Your Mail Box In A View Minutes.
							</p>
                            <p class="submit">
    ...
    $("#registerButton").click(function() { 
        ...
        success: function(d) {
	        ...
	        <div class="post">
					...
					<p>Cras mauris sem, posuere vel semper sed, condimentum non dui. Suspendisse vestibulum ligula eget urna posuere sagittis. Suspendisse sed nisl massa. Read More</a></p>
					<div class="cl">&nbsp;</div>
				</div>
		</div>
		<!-- End Main -->
